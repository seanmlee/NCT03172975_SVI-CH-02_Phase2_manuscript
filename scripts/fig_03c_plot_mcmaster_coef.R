...
# fit model --------------------------------------------------------------------
mod_mcmaster_dose <- glm(
  log(max_egg_count + 0.1) ~
    dose,
  data = dv_max
)
sjPlot::tab_model(mod_mcmaster_dose, transform = "exp", show.r2 = FALSE, digits = 3)
...
mcmaster_coef$data <- mcmaster_coef$data %>%
